...
cor.test(motorcars$deaths, motorcars$drivers,method="pearson") #Correlation by Pearson +??·??????°N??N??N??N??N??N??N??

cor.test(motorcars$deaths, motorcars$drivers,method="spearman") #Correlation by Spearman +??·??????°N??N??N??N??N??N??N??

cor.test(motorcars$deaths, motorcars$drivers,method="kendal")#Correlation by Kendall +??·??????°N??N??N??N??N??N??N??
...
plot(motorcars$drivers, motorcars$popden) #????N????°??????????µN?? + ????N??N??N????????????°
plot(motorcars$drivers, motorcars$rural) #????N????°??????????µN?? +N??N??N????°??»
plot(motorcars$drivers, motorcars$temp) #????N????°??????????µN??+N????µ????????
...
heatmap(x = res, col = palette, symm = TRUE)    #????N????°N??N?????? ????????N????µ??»N??N??N??N?? N??????????N?? heatmap
