...
namespace LongArifm
{
    class LongCalculator
    {
        ...
        public bool proste(string n)
        {
            if (Equal(Add("0", fact(Sub(n, "1")), n), Sub(n, "1"))) return true;
            return false;
        }
        ...
        public string rand(string a, string b) //return random n Є [a, b]
        {
            Random rand = new Random();
            string res = "1";
        ...
        public bool SoloveyShtrassen(string a) //return prost(a)
        {
