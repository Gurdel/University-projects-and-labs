...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_PARENT = 4,                     /* PARENT  */
  YYSYMBOL_PROCOPT = 5,                    /* PROCOPT  */
  YYSYMBOL_SSPTR = 6,                      /* SSPTR  */
  YYSYMBOL_INDICES = 7,                    /* INDICES  */
  YYSYMBOL_SENSEG = 8,                     /* SENSEG  */
  YYSYMBOL_PUNCHEDCARD = 9,                /* PUNCHEDCARD  */
  YYSYMBOL_NUM = 10,                       /* NUM  */
  YYSYMBOL_ID = 11,                        /* ID  */
  YYSYMBOL_12_ = 12,                       /* ','  */
  YYSYMBOL_13_ = 13,                       /* '='  */
...
{
       0,   225,   225,   228,   233,   234,   238,   239,   240,   241,
     242,   245,   246,   247,   250,   251,   252,   256,   257
};
#endif
...
{
  "\"end of file\"", "error", "\"invalid token\"", "NAME", "PARENT",
  "PROCOPT", "SSPTR", "INDICES", "SENSEG", "PUNCHEDCARD", "NUM", "ID",
  "','", "'='", "'('", "')'", "$accept", "PROGRAM", "OPS", "LIST_OP", "OP",
...
{
      -1,    -3,     8,   -12,     4,     6,     7,     9,    10,    12,
     -12,   -12,    -5,    -5,    -5,    -5,    -5,    -3,   -12,   -12,
       5,   -12,   -12,   -12,   -12,   -12,   -12,   -12,   -12,     3,
      13,   -12,     5,   -12
};
...
{
       0,     0,     0,     2,     0,     0,     0,     0,     0,     3,
       5,     1,     0,     0,     0,     0,     0,     0,    11,    12,
      14,     6,     7,     8,     9,    10,     4,    17,    18,     0,
      15,    13,    14,    16
};
...
{
       4,     5,     6,     7,     8,    18,    19,     1,    11,    20,
      26,    22,    23,    24,    25,    27,    28,    12,    31,    13,
      14,    33,    15,    16,    17,    32
};

static const yytype_int8 yycheck[] =
{
       3,     4,     5,     6,     7,    10,    11,     8,     0,    14,
      17,    13,    14,    15,    16,    10,    11,    13,    15,    13,
      13,    32,    13,    13,    12,    12
};
...
{
       0,     8,    17,    18,     3,     4,     5,     6,     7,    19,
      20,     0,    13,    13,    13,    13,    13,    12,    10,    11,
      14,    21,    21,    21,    21,    21,    20,    10,    11,    22,
      23,    15,    12,    22
};
...
#line 225 "senseg.y"
                                        { tree = (yyvsp[0].oper); }
#line 1292 "senseg.tab.cpp"
    break;

  case 3: /* OPS: SENSEG LIST_OP  */
#line 228 "senseg.y"
                                           { (yyval.oper) = new pr((yyvsp[0].oper)); }
#line 1298 "senseg.tab.cpp"
    break;

  case 4: /* LIST_OP: LIST_OP ',' OP  */
#line 233 "senseg.y"
             { (yyval.oper) = new listPr((yyvsp[-2].oper), (yyvsp[0].oper)); }
#line 1304 "senseg.tab.cpp"
    break;

  case 5: /* LIST_OP: OP  */
#line 234 "senseg.y"
     { (yyval.oper) = new listPr(NULL, (yyvsp[0].oper)); }
#line 1310 "senseg.tab.cpp"
    break;

  case 6: /* OP: NAME '=' TERM  */
#line 238 "senseg.y"
                                { (yyval.oper) = new ParserExpression("NAME", NULL , (yyvsp[0].oper) , true); }
#line 1316 "senseg.tab.cpp"
    break;

  case 7: /* OP: PARENT '=' TERM  */
#line 239 "senseg.y"
                                { (yyval.oper) = new ParserExpression("PARENT", (yyvsp[0].oper), NULL, true); }
#line 1322 "senseg.tab.cpp"
    break;

  case 8: /* OP: PROCOPT '=' TERM  */
#line 240 "senseg.y"
                                { (yyval.oper) = new ParserExpression("PROCOPT", (yyvsp[0].oper), NULL, true); }
#line 1328 "senseg.tab.cpp"
    break;

  case 9: /* OP: SSPTR '=' TERM  */
#line 241 "senseg.y"
                                { (yyval.oper) = new ParserExpression("SSPTR", (yyvsp[0].oper), NULL, true); }
#line 1334 "senseg.tab.cpp"
    break;

  case 10: /* OP: INDICES '=' TERM  */
#line 242 "senseg.y"
                                { (yyval.oper) = new ParserExpression("INDICES", (yyvsp[0].oper), NULL, true); }
#line 1340 "senseg.tab.cpp"
    break;

  case 11: /* TERM: NUM  */
#line 245 "senseg.y"
                                        { (yyval.oper) = new value((yyvsp[0].str)); }
#line 1346 "senseg.tab.cpp"
    break;

  case 12: /* TERM: ID  */
#line 246 "senseg.y"
                                        { (yyval.oper) = new value((yyvsp[0].str)); }
#line 1352 "senseg.tab.cpp"
    break;

  case 13: /* TERM: '(' ARGS ')'  */
#line 247 "senseg.y"
                                        { (yyval.oper) = new ParserExpression((yyvsp[-1].args), true, true, false, true); }
#line 1358 "senseg.tab.cpp"
    break;

  case 14: /* ARGS: %empty  */
#line 250 "senseg.y"
                                        { }
#line 1364 "senseg.tab.cpp"
    break;

  case 15: /* ARGS: ARG  */
#line 251 "senseg.y"
                                        { (yyval.args) = new ParserExpression((yyvsp[0].oper), true, false, true); }
#line 1370 "senseg.tab.cpp"
    break;

  case 16: /* ARGS: ARG ',' ARGS  */
#line 252 "senseg.y"
                                        { (yyval.args) = new ParserExpression((yyvsp[-2].oper), true, false, false, (yyvsp[0].args)); }
#line 1376 "senseg.tab.cpp"
    break;

  case 17: /* ARG: NUM  */
#line 256 "senseg.y"
                                        { (yyval.oper) = new value((yyvsp[0].str)); }
#line 1382 "senseg.tab.cpp"
    break;

  case 18: /* ARG: ID  */
#line 257 "senseg.y"
                                        { (yyval.oper) = new value((yyvsp[0].str)); }
#line 1388 "senseg.tab.cpp"
    break;


#line 1392 "senseg.tab.cpp"
